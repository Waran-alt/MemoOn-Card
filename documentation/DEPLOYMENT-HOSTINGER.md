...
Ou en combinant avec l’app : `docker compose -f docker-compose.prod.yml -f docker-compose.monitoring.yml --env-file .env up -d`.
...
**CI/CD** : le workflow Hostinger ne lance pas ce compose par défaut ; à activer manuellement sur le VPS ou à étendre le workflow si vous voulez le déploiement automatique du monitoring.
