...
router.patch(
  ...
  asyncHandler(async (req, res) => {
    ...
    const row = await adminFeatureFlagsService.updateFlag(adminUserId, String(flagKey), {
...
router.put(
  ...
  asyncHandler(async (req, res) => {
    ...
    const row = await adminFeatureFlagsService.upsertOverride(adminUserId, String(flagKey), String(userId), {
      enabled: req.body.enabled,
